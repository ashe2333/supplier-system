package com.practice.supplier.untils;
...
public class CodeGenerator {
    ...
    // datasource
    private final static String URL = "jdbc:mysql://106.52.132.118:3306/supplier_system?serverTimezone=GMT%2B8&allowMultiQueries=true&characterEncoding=UTF-8";
    private final static String DRIVER = "com.mysql.cj.jdbc.Driver";
    private final static String USERNAME = "root";
    private final static String PASSWORD = "Xyz@123456";


    private final static String PARENT = "com.practice";
...
//        strategy.setSuperControllerClass("com.baomidou.ant.common.BaseController");
        ...
        strategy.setSuperEntityClass("com.practice.supplier.common.domain.BaseEntity");
