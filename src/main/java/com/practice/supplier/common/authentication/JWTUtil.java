package com.practice.supplier.common.authentication;
...
import com.practice.supplier.untils.EncryptUtils;
...
public class JWTUtil {
     ...
     * @return 是否正确
     */
    public static boolean verify(String token, Integer userId, Integer role) {
        try {
     ...
     * @return token
     */
    public static String sign(Integer userId,Integer role) {
        try {
